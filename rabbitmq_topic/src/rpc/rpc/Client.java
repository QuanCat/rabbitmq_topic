...
public class Client {
	...
	public String call(String message) throws Exception {
		...
		channel.basicPublish("rpc", "ping", getRequestProperties(),
				message.getBytes());
	...
	public static String createRequest() throws JSONException {
		float epoch = System.currentTimeMillis() / 1000;
		JSONStringer msg = new JSONStringer();
		return msg.object().key("client_name").value("RPC Client 1.0")
				.key("time").value(Float.toString(epoch)).endObject()
				.toString();
	}
